...
/* This example shows how to use @Test dependsOnMethods */
...
class Example6 {
	...
	public void login() {
		...
		driver.findElement(By.name("userName")).sendKeys("mercuryy");

		driver.findElement(By.name("password")).sendKeys("mercuryy");
